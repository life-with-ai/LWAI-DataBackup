...
LWAI DataBackup 1.3.0 использует Microsoft .NET Framework и Windows Forms как системную Windows runtime/UI platform. Отдельный runtime в portable ZIP не распространяется.
